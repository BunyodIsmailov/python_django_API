...
class TelefonlarView(APIView):
    ...
    def post(self, request):
        ...
        return Response({"success": f"Telefonlar '{article_saved.brend}' created successfully"})
    ...
    def put(self, request, pk):
        ...
        if serializer.is_valid(raise_exception=True):
            article_saved = serializer.save()
        return Response({"success": f"Telefonlar '{article_saved.brend}' update successfully"})
